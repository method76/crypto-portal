<template>
  ...
  <div class="container-fluid">
    <div style="position:absolute; top:188px;left:50%; margin-left:-880px; width:160px;height: 600px;background-color: #fafafa;"></div>
    <!-- 가로 광고 Start -->
    <div class="row">
      <div class="col-12">
        <Adsense
    ...
    <div class="row m-b-10">
      <div class="carousel slide col-lg-6 col-9 p-0" data-ride="carousel">
        <!-- Indicators -->
        ...
        <div class="carousel-inner">
          <div id="demo1" class="carousel-item" style="background-image: url(https://s1.tokenpost.kr/assets/uploads/201902281f7a507d018fea670.jpg);">
            <div class="carousel-caption">
              <h3>토큰포스트</h3>
              <p>日 작년 암호화폐 관련 자금 세탁 ‘10배’ 증가</p>
            </div>
          </div>
          <div id="demo2" class="carousel-item carousel-item-left" style="background-image: url(https://s1.tokenpost.kr/assets/uploads/20190305b14da082e8a03ece1.jpg);">
            <div class="carousel-caption">
              <h3>토큰포스트</h3>
              <p>스타벅스, 백트(Bakkt) 파트너십 일환 ‘암호화폐’ 결제 가능성 제기돼</p>
            </div>
          </div>
          <div id="demo3" class="carousel-item carousel-item-next carousel-item-left" style="background-image: url(https://s1.tokenpost.kr/assets/uploads/201903055f9c082612fd11117.png);">
            <div class="carousel-caption">
              <h3>토큰포스트</h3>
      ...
      <div class="col-lg-2 col-3 p-0">
        <a class="w200" href="javascript:void(0);"><img src="https://s1.tokenpost.kr/assets/uploads/2019030513481e5cdebc2c838.jpg" alt="" class="img-fluid img-thumbnail"></a>
        <a class="w200" href="javascript:void(0);"><img src="https://s1.tokenpost.kr/assets/uploads/20190305c6b477e6a1232e303.png" alt="" class="img-fluid img-thumbnail"></a>
        <a class="w200" href="javascript:void(0);"><img src="https://s1.tokenpost.kr/assets/uploads/20190309267896042fabb8961.jpg" alt="" class="img-fluid img-thumbnail"></a>
      </div>

      <div class="col-lg-4 col-12 p-0">
        <h3><i class="zmdi zmdi-tv-alt-play"></i> 블록체인 <strong>뉴스</strong></h3>
        <table class="table table-bordered table-hover m-b-0 articles">
          <tbody>
          <tr>
            <td class="footable-first-visible" style="display: table-cell;"><a href="https://tokenpost.kr/article-6013" class="text-muted ellipsis" target="_blank">[디스트리트] 日 작년 암호화폐 관련 자금 세탁 ‘10배’ 증가</a></td>
          </tr>
          <tr>
            <td class="footable-first-visible" style="display: table-cell;"><a href="https://tokenpost.kr/article-6051" class="text-muted ellipsis" target="_blank">[토큰포스트] 스타벅스, 백트(Bakkt) 파트너십 일환 ‘암호화폐’ 결제 가능성 제기돼</a></td>
          </tr>
          <tr>
            <td class="footable-first-visible" style="display: table-cell;"><a href="https://tokenpost.kr/article-6050" class="text-muted ellipsis" target="_blank">[디스트리트] 서클, ‘시드인베스트(SeedInvest)’ 인수 완료…크라우드펀딩·토큰화 결합</a></td>
          </tr>
          <tr>
            <td class="footable-first-visible" style="display: table-cell;"><a href="https://tokenpost.kr/article-6044" class="text-muted ellipsis" target="_blank">[토큰포스트] 리플, 샌프란시스코 베이 ‘일하기 좋은 중소기업’ 선정</a></td>
          </tr>
          <tr>
    ...
    <div class="row clearfix media-wrapper">
      ...
      <div class="col-lg-4 col-12 media-latest">
        <!-- 소셜 글 목록 #1 Start -->
        <h3><i class="zmdi zmdi-face"></i> 암호화폐 <strong>소셜네트워크</strong></h3>
      ...
      <div class="col-lg-4 col-12">
        <h3 class="title-latest"><i class="zmdi zmdi-trending-up"></i> 암호화폐 <strong>시세</strong> <a href="https://www.coingecko.com/ko" target="_blank"><span class="badge badge-info">더보기</span></a></h3>
        <coingecko-coin-list-widget  coin-ids="bitcoin,eos,ethereum,ripple,mossland,mediblocx" currency="krw" locale="ko" class="clearfix"></coingecko-coin-list-widget>
      </div>
